...
# Caption format: short stylized title (one line) + blank line + hashtags.
# Title pulled from each clip plan's `title` field (4-7 word YouTube-style hot
# take, generated by pick_clips.py). Per user, the title is for at-a-glance
# topic context; hashtags still drive discovery so we cap title length and
# preserve the 15-tag ceiling below.
#
